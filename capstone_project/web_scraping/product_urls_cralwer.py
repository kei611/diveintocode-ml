...
CSV_FILENAME = "other_brands_asics.csv"
IMPLICIT_WAIT = 10
...
#     checkbox_jordan_xpath   = f"/html/body/div[1]/div[1]/div[2]/div[2]/div[3]/div/div/div[1]/div/div[3]/div[1]/div[2]/div[{i}]/div/label"
...
# ページネーション突起
k = 1
base_url = 'https://stockx.com/other-sneakers/asics?size_types=men'
while True:
