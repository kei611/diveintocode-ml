...
# titanic_paclage documentation build
...
from titanic_paclage import __version__ as release

# -- Project information -----------------------------------------------------

project = "titanic_paclage"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "titanic_paclagedoc"
...
texinfo_documents = [
    (
        ...
        author,
        "titanic_paclage",
        "Project titanic_paclage codebase.",
        "Data-Science",
    )
]
